...
// ─── PALETA MODO CLARO ───────────────────────────────────────────────────────
val EnerLightBackground      = Color(0xFFF4F6F8)
val EnerLightSurface         = Color(0xFFFFFFFF)
val EnerLightSurfaceVariant  = Color(0xFFEAEEF3)
val EnerLightSurfaceElevated = Color(0xFFDDE3EC)
val EnerLightTextPrimary     = Color(0xFF0D1117)
val EnerLightTextSecondary   = Color(0xFF4A5568)
val EnerLightTextHint        = Color(0xFF8B9DC3)
val EnerLightBorder          = Color(0xFFCDD5E0)
val EnerLightDivider         = Color(0xFFCDD5E0)
val EnerLightGoogleButton    = Color(0xFFEAEEF3)